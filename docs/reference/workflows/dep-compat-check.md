...
The workflow uses a tracking epic issue. The `EPIC` constant in the workflow file must be set to the issue number during repository setup (see step 8 in the template repository's SETUP.md — that file is not part of this repository).
