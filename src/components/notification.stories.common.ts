...
const SVG_CLOSE = '<svg fill="#FFFFFF" opacity="0.4" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><g><path d="M437.02,74.98C388.667,26.628,324.38,0,256,0S123.333,26.628,74.98,74.98C26.628,123.333,0,187.62,0,256s26.628,132.667,74.98,181.02C123.333,485.372,187.62,512,256,512s132.667-26.628,181.02-74.98C485.372,388.667,512,324.38,512,256S485.372,123.333,437.02,74.98z M256,491.602c-129.911,0-235.602-105.69-235.602-235.602S126.089,20.398,256,20.398S491.602,126.089,491.602,256S385.911,491.602,256,491.602z"/></g><g><path d="M318.022,256l84.75-84.749c3.983-3.984,3.983-10.442,0-14.425l-47.599-47.599c-3.984-3.982-10.442-3.982-14.425,0L256,193.978l-84.749-84.75c-3.984-3.982-10.442-3.982-14.425,0l-47.599,47.599c-3.983,3.984-3.983,10.442,0,14.425L193.978,256l-84.75,84.749c-3.983,3.984-3.983,10.442,0,14.425l47.599,47.599c3.984,3.982,10.442,3.982,14.425,0L256,318.022l84.75,84.749c1.991,1.991,4.602,2.987,7.212,2.987s5.22-0.995,7.212-2.986l47.599-47.599c3.983-3.984,3.983-10.442,0-14.425L318.022,256z"/></g></svg>';

const CLOSE_ICON_NAME = 'storybook-close';

// ─── Provider Decorators ─────────────────────────────────────────────────────

export function withDefaultFontIcons() {
...
export function withCustomFontIcons() {
    return applicationConfig({
        providers: [
            provideAnimationsAsync(),
            provideTbxMatSeverityTheme({ invert: false, applyToRoot: true }),
...
export function withDefaultSvgIcons() {
    return applicationConfig({
        providers: [
            provideAnimationsAsync(),
            provideTbxMatSeverityTheme({ invert: false, applyToRoot: true }),
...
export function withCustomSvgIcons() {
    return applicationConfig({
        providers: [
            provideAnimationsAsync(),
            provideTbxMatSeverityTheme({ invert: false, applyToRoot: true }),
        ...
        providers: [
            ...
            },
            {
                ...
                useFactory: () => {
                    ...
                    registry.addSvgIconLiteral(CLOSE_ICON_NAME, sanitizer.bypassSecurityTrustHtml(SVG_CLOSE));
...
export const LARGE_ICON_ONLY_CSS = `
    html {
        --tbx-mat-notification-icon-size: 3rem;
    }
`;
...
export class NotificationHarnessComponent {
