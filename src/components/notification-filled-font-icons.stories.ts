...
import { NotificationHarnessComponent, SHARED_ARG_TYPES, DEFAULT_ARGS, withDefaultFontIcons, withCustomProperties, FILLED_CSS, COMPACT_CSS, LARGE_CSS, LARGE_ICON_ONLY_CSS } from './notification.stories.common';
...
const CATEGORY_DESCRIPTION = 'Uses font-variation-settings FILL 1 to render filled Material Symbols. ' + 'Same default ligatures as the outlined variant (check_circle, error, warning_amber, info, help).';
