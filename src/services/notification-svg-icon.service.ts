...
/**
 * Default SVG icons from the "Small Flat Vectors" collection on SVG Repo.
 ...
 *
 * Extends {@link TbxMatSeveritySvgIconService} and registers default SVG
 * icons for each severity level. The inherited `resolve()` and severity
 ...
 * ```typescript
 * // app.config.ts
 * import { TBX_MAT_NOTIFICATION_PROVIDER_CONFIG, TbxMatNotificationSvgIconService } from '@teqbench/tbx-mat-notifications';
 *
 * providers: [
 *     {
...
export class TbxMatNotificationSvgIconService extends TbxMatSeveritySvgIconService {
     ...
     *
     * Icons are from the "Small Flat Vectors" collection on SVG Repo.
