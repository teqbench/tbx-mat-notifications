...
To report a vulnerability, open a [GitHub Security Advisory](https://github.com/teqbench/tbx-mat-notifications/security/advisories/new) via the **Security** tab of this repository. This keeps the report private until a fix is available.
